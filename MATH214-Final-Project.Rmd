...
Accidents_2017$Vehicles_Num <- as.factor(Accidents_2017$Vehicles_Num)
...
# Number of accidents in each day of the week
...
ggplot(daily,aes(Accidents_Date,resid))+
...
ggplot(Climate,aes(Month,resid)) +
...
ggplot(Climate,aes(Accidents_Date,resid))+
